package com.finalpretty.app.ecpay.payment.integration;
...
import com.finalpretty.app.ecpay.payment.integration.domain.ATMRequestObj;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutALL;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutATM;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutApplePay;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutCVS;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutDevide;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutOneTime;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutPeriod;
import com.finalpretty.app.ecpay.payment.integration.domain.AioCheckOutWebATM;
import com.finalpretty.app.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import com.finalpretty.app.ecpay.payment.integration.domain.CreateServerOrderObj;
import com.finalpretty.app.ecpay.payment.integration.domain.DoActionObj;
import com.finalpretty.app.ecpay.payment.integration.domain.FundingReconDetailObj;
import com.finalpretty.app.ecpay.payment.integration.domain.InvoiceObj;
import com.finalpretty.app.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import com.finalpretty.app.ecpay.payment.integration.domain.QueryTradeInfoObj;
import com.finalpretty.app.ecpay.payment.integration.domain.QueryTradeObj;
import com.finalpretty.app.ecpay.payment.integration.domain.TradeNoAioObj;
import com.finalpretty.app.ecpay.payment.integration.ecpayOperator.EcpayFunction;
...
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyAioCheckOut;
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyDoAction;
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyQueryTrade;
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import com.finalpretty.app.ecpay.payment.integration.verification.VerifyTradeNoAio;
