package com.finalpretty.app.ecpay.payment.integration.ecpayOperator;
...
public class PaymentVerifyBase {
	protected String confPath = "/com/finalpretty/app/ecpay/payment/integration/config/EcpayPayment.xml";
