package com.finalpretty.app.ecpay.payment.integration.verification;
...
import com.finalpretty.app.ecpay.payment.integration.ecpayOperator.PaymentVerifyBase;
...
public class VerifyCreateServerOrder extends PaymentVerifyBase {
	...
	public void verifyParams(CreateServerOrderObj obj) {
		...
		for (int i = 0; i < nodeList.getLength(); i++) {
			...
			// requireCheck(tmpEle.getAttribute("name"), objValue,
			// tmpEle.getAttribute("require").toString());
